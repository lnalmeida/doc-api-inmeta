...
const setupSwagger = (app: INestApplication) => {
  const swaggerConfig = new DocumentBuilder()
    ...
    .setDescription(
      'API RESTful para gerenciar a documentação obrigatória de colaboradores e o status de envio.',
    )
    .setVersion('1.0')
    ...
    .addTag(
      'employee-documents',
      'Operações de vinculação e status de documentos de colaboradores',
    )
    .build();
