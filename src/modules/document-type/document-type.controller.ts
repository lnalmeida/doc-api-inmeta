...
export class DocumentTypeController {
  ...
  @ApiResponse({
    ...
    description: 'Tipo de documento com o mesmo nome já existe.',
  })
  @ApiResponse({
  ...
  async create(
    ...
    const documentType = await this.documentTypeService.create(
  ...
  @ApiQuery({
    ...
    required: false,
    type: String,
    description: 'Filtrar por nome do tipo de documento (busca parcial)',
  })
  @ApiResponse({
  ...
  async findAll(
    @Query() filters: ListDocumentTypeDto,
  ): Promise<PaginationResult<DocumentTypeResponseDto>> {
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Detalhes do tipo de documento.',
    type: DocumentTypeResponseDto,
  })
  @ApiResponse({
  ...
  async update(
    ...
    const documentType = await this.documentTypeService.update(
      id,
